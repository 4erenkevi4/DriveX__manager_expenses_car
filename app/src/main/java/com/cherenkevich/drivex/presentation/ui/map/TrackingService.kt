...
import com.cherenkevich.drivex.utils.Constans.ACTION_PAUSE_SERVICE
import com.cherenkevich.drivex.utils.Constans.ACTION_START_OR_RESUME_SERVICE
import com.cherenkevich.drivex.utils.Constans.ACTION_STOP_SERVICE
import com.cherenkevich.drivex.utils.Constans.FASTEST_LOCATION_UPDATE_INTERVAL
import com.cherenkevich.drivex.utils.Constans.LOCATION_UPDATE_INTERVAL
import com.cherenkevich.drivex.utils.Constans.NOTIFICATION_CHANNEL_ID
import com.cherenkevich.drivex.utils.Constans.NOTIFICATION_CHANNEL_NAME
import com.cherenkevich.drivex.utils.Constans.NOTIFICATION_ID
import com.cherenkevich.drivex.utils.Constans.TIMER_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean) {
        ...
        val pendingIntent = if (isTracking) {
            ...
            PendingIntent.getService(this, 1, pauseIntent, pendingFlags)
        } else {
            val resumeIntent = Intent(this, TrackingService::class.java).apply {
                action = ACTION_START_OR_RESUME_SERVICE
            }
            PendingIntent.getService(this, 2, resumeIntent, pendingFlags)
        }
        val notificationManager =
            getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
